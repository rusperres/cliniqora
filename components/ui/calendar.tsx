...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background p-2 [--cell-radius:theme('borderRadius.md')] [--cell-size:theme('spacing.7')] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
